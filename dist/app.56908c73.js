...
var character = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var charact, charactArray, template, target;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            charact = _context.sent;
            _context.next = 5;
            return charact.json();

          case 5:
            charactArray = _context.sent;
            console.log(charactArray);
            template = document.getElementById('templ');
            target = document.getElementById('target');
            charactArray.forEach(function (el) {
              var charactHTML = template.cloneNode(true).content;
